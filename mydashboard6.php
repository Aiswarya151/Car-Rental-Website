    ...
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form" action="connect_dash.php" method="post">
                <span class="login100-form-title">Tata Hexa</span>
                ...
                <input class="input100" type="text" name="car" value="Tata Hexa" readonly>
                <span class="focus-input100"></span>
            </div>
                ...
                <input class="input100" type="text" name="price" value="7500" readonly>
                <span class="focus-input100"></span>
            </div>
