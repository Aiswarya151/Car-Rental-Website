    ...
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form" action="connect_dash.php" method="post">
                <span class="login100-form-title">Hyndai Creta</span>
                ...
                <input class="input100" type="text" name="car" value="Hyundai Creta" readonly>
                <span class="focus-input100"></span>
            </div>
                ...
                <input class="input100" type="text" name="price" value="6850" readonly>
                <span class="focus-input100"></span>
            </div>
