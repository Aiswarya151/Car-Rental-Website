    ...
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form" action="connect_dash.php" method="post">
                <span class="login100-form-title">Tata Manza</span>
                ...
                <input class="input100" type="text" name="car" value="Tata Manza" readonly>
                <span class="focus-input100"></span>
            </div>
                ...
                <input class="input100" type="text" name="price" value="5500" readonly>
                <span class="focus-input100"></span>
            </div>
